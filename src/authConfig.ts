...
export const msalConfig: Configuration = {
  auth: {
    clientId: 'f1041483-e6ea-4f04-a602-5cad20a33b36', // This is the ONLY mandatory field that you need to supply.
    authority:
      'https://login.microsoftonline.com/f39d70f4-8b8a-46f1-ad1d-eb36979e6c4e', // Defaults to "https://login.microsoftonline.com/common"
